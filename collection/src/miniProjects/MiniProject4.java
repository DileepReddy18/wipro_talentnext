...
class Cardp {
    ...
    public Cardp(String symbol, int number) {
        this.symbol = symbol.toLowerCase(); // optional normalization
        this.number = number;
    }
...
public class MiniProject4 {
	...
	public static void main(String[] args) {
        ...
        Map<String, List<Cardp>> cardMap = new TreeMap<>(); // TreeMap to keep keys sorted
        ...
        // Print all distinct symbols in alphabetical order
